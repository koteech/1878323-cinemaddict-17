import {generateDate, getRandomArrayElement, getRandomInteger, getTimeFromMins} from '../utils/utils';
...
export const generateMovies = (size, comments = []) => Array.from({length: size}, () => generateMovie(comments));
